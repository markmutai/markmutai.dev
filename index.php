                    ...
                    <div class="row phone-m:mx-0 phone-l:mx-1 md:mx-4 lg:mx-4 xl:mx-3 2xl:mx-4">
                        <div class="col-xl-6 col-lg-12">
                            <div class="thumbnail">
                                ...
                                <ul>
                                    ...
                                    <li>Integrated Microsoft&reg; booking system (Microsoft&reg; 365)</li>
                        ...
                        <div class="col-xl-6 col-lg-12 mm-work">
                            <div class="thumbnail">
                                ...
                                <ul>
                                    <p>Key Features:</p>
                                    <li>Logo redesign (Autodesk&reg; Sketchbook, Affinity Designer)</li>
                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="thumbnail">
                                ...
                                <p>
                                    Display of connected stock market via Microsoft&reg; Azure API, with user adjustable data requests and timeframes
                                </p>
                                <br/>
                                <ul>
                                    <p>Key Features:</p>
                                    ...
                                    <li>Dynamic data collection via Microsoft&reg; Azure API</li>
                                </ul>">
                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="thumbnail">
                                <a class="lightbox" href="app/img/work/hudsons.webp" data-caption="
                                        ...
                                        <ul>
                                            <p>Key Features:</p>
                                            <li>Logo design (Affinity Designer, Autodesk&reg; Sketchbook)</li>
                            ...
                            <div class="thumbnail">
                                <a class="lightbox" href="app/img/work/sipnsmoke.webp" data-caption="
                                        ...
                                        <ul>
                                            <p>Key Features:</p>
                                            <li>Logo design (Affinity Designer)</li>
                                            <li>Hand-drawn typography (Autodesk&reg; Sketchbook)</li>
                            ...
                            <div class="thumbnail">
                                <a class="lightbox" href="app/img/work/ipcl_logo.webp" data-caption="
                                        ...
                                        <ul>
                                            <p>Key Features:</p>
                                            <li>Hand-drawn logo</li>
                                            <li>Logo design (Adobe&reg; Illustrator)</li>
                                            <li>Logo post-FX (Adobe&reg; Photoshop)</li>
                                        </ul>">
                            ...
                            <div class="thumbnail">
                                <a class="lightbox" href="app/img/work/supertumtums.webp" data-caption="
                                        ...
                                        <ul>
                                            ...
                                            <li>Character design (Affinity Designer, Autodesk&reg; Sketchbook)</li>
